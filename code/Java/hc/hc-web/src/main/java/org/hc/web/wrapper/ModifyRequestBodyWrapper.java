...
public class ModifyRequestBodyWrapper extends HttpServletRequestWrapper {
    ...
    public String getContentType() {
        return StrUtil.isBlank(contentType) ? orginalRequest.getContentType() : contentType;
    }
    ...
    public Enumeration<String> getHeaders(String name) {
        if (null != name && name.replace("-", "").toLowerCase().equals("contenttype") && !StrUtil.isBlank(contentType)) {
